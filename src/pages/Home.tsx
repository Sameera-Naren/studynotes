      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl md:text-6xl">
            ...
            <span className="text-blue-600"> Enhance Learning</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            A collaborative platform for university students to share and access lecture notes.
              ...
              <div className="flow-root bg-white rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    Access comprehensive lecture notes from your peers to enhance your understanding.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    Share your notes with classmates and help others succeed in their studies.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    Join a community of students helping each other excel in their academic journey.
                  </p>
                </div>
              </div>
            </div>
